...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    private FantacyApplication aController = null;
    ...
    protected void onRegistered(Context context, String registrationId) {
        ...
        AppConstant. Register_Id=registrationId;
        Log.i(TAG, "Device registered: regId = " + registrationId);
      /*  aController.displayMessageOnScreen(context, 
                                           "Your device registred with GCM");*/
       // Log.d("NAME", MainActivity.name);
        aController.register(context, GetSet.getUserName(), GetSet.getEmail()
                               , registrationId);
    }
	...
	private static void generateNotification(Context context, String message) {
        ...
        //MessagesFragment.class.g
        
        FragmentChangeActivity.rsnote = true;
        Intent notificationIntent = new Intent(context, FragmentChangeActivity.class);
