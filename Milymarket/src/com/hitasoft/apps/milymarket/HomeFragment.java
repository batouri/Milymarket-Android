...
//	private GridView gridView;
	...
	private void parsing(Integer page) {
		...
		String urlAddr = ConstantValues.home + "?offset=" + page * 10;
		//		+ "&limit=16";
	...
	public class AdapterForHdpi extends BaseAdapter {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				view = inflater.inflate(layout, parent, false);//layout
			} else {
				view = convertView;
				view.forceLayout();
			}
		...
		*/	
			...
			homeImageLoader.displayImage(tempMap.get(ConstantValues.TAG_ITEM_URL_MAIN_350), image, defaultOptions, 
			...
			homeImageLoader.displayImage(
					tempMap.get(ConstantValues.TAG_USER_URL_MAIN_70),sellerimage,defaultOptions,
					new ImageLoadingListener() {
